...
function makeCustomStory (data) {
    ...
    e.preventDefault();
    let blueArrows1 = document.getElementById('blue-arrow')
    blueArrows1.style.display = 'none'
    let blueArrows2 = document.getElementById('blue-arrow-2')
    blueArrows2.style.display = 'none'
